...
;
var MessageActionHandlerMap = (_a = {},
    _a[message_1.MessageTypes.textMessage] = (_b = {},
        _b[message_1.ActionTypes.post] = function (message, store, user, socket) {
    ...
    _a[message_1.MessageTypes.channelCommand] = (_c = {},
        _c[message_1.ActionTypes.post] = function (message, store, user, socket) {
            console.log("hi cc");
        ...
        _c[message_1.ActionTypes.get] = function (message, store, user, socket) {
            user.writeToAllSockets(JSON.stringify(store.channels.store));
        },
        _c),
    _a);
exports.messageHandler = function (message, store, user, thisSocket) {
